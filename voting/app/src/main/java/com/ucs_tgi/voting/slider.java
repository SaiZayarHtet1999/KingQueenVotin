...
public class slider extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View rightSlider=findViewById(R.id.textSlider);
        SCViewAnimation rightsliderAni = new SCViewAnimation(rightSlider);
        rightsliderAni.addPageAnimation(new SCPositionAnimation(this, 0, -size.x, 0));
        mViewPager.addAnimation(rightsliderAni);
        ...
        atSkexAnimation.addPageAnimation(new SCPositionAnimation(getApplicationContext(), 0, 0, -( size.y - (atSkex.getHeight() -300))));
        ...
        View userGuide1=findViewById(R.id.userguiderule1);
        SCViewAnimation userGuideAni1 = new SCViewAnimation(userGuide1);
        userGuideAni1.startToPosition(size.x, null);
        userGuideAni1.addPageAnimation(new SCPositionAnimation(this, 1, -size.x, 0));
        userGuideAni1.addPageAnimation(new SCPositionAnimation(this, 2, -size.x, 0));
        mViewPager.addAnimation(userGuideAni1);
        ...
        Button btnOpen=findViewById(R.id.textview_main_linkedin_link);
        ...
        View user_guide3View=findViewById(R.id.user_guide3);
        SCViewAnimation user_guide3Ani = new SCViewAnimation(user_guide3View);
        user_guide3Ani.startToPosition(size.x, null);
        user_guide3Ani.addPageAnimation(new SCPositionAnimation(this, 3, -size.x, 0));
        mViewPager.addAnimation(user_guide3Ani);
    }
}
